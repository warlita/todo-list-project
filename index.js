$(document).ready(function () {
  ...
  var markTaskComplete = function (id) {
    $.ajax({
   type: 'PUT',
      url: 'https://fewd-todolist-api.onrender.com/tasks/' + id + '/mark_complete?api_key=1212',
      dataType: 'json',
      success: function (response, textStatus) {
        getAndDisplayAllTasks();
      },
  ...
  var markTaskActive = function (id) {
    $.ajax({
   type: 'PUT',
      url: 'https://fewd-todolist-api.onrender.com/tasks/' + id + '/mark_active?api_key=1212',
      dataType: 'json',
      success: function (response, textStatus) {
        getAndDisplayAllTasks();
      },
